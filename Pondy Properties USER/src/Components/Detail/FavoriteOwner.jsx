      ...
      property.updatedAt && property.updatedAt !== property.createdAt
        ...
        : new Date(property.createdAt).toLocaleDateString('en-IN', {
            ...
            day: 'numeric'
                        ...
                        <h6 className="m-0">
                                   <span style={{ fontSize:'15px', color:'#2F747F', fontWeight:'bold', letterSpacing:"1px" }}> <FaRupeeSign className="me-2" color="#2F747F"/>
    {property.price
...
const fetchInterestedProperties = useCallback(async () => {
  ...
  try {
    ...
    const favoriteData = Array.isArray(data.favoriteRequestsData)
...
    </button> <h3 className="m-0 ms-3" style={{fontSize:"20px"}}>MY SHORTLIST PROPERTY</h3> </div>
