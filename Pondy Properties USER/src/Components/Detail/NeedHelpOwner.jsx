...
const sortedHelpRequests = data.helpRequestsData.sort(
  (a, b) => new Date(b.updatedAt || b.createdAt) - new Date(a.updatedAt || a.createdAt)
    ...
    setProperties(sortedHelpRequests);  
    localStorage.setItem("helpProperties", JSON.stringify(sortedHelpRequests));  
  } catch (error) {
   } finally {
    setLoading(false);
  }
...
    </button> <h3 className="m-0 ms-3" style={{fontSize:"15px"}}>HELP REQUEST BUYER </h3> </div>
