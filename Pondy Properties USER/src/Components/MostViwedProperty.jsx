...
const fetchLastViewed = async () => {
  try {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/user-most-viewed-properties/${phoneNumber}`
    );
    ...
    // ⬇️ Enrich each unique property with propertyMessage
    ...
    console.error("Error fetching most viewed properties:", err);
    setProperties([]); // Optional: show empty state
  } finally {
    setLoading(false);
  }
};
