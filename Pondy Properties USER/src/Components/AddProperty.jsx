...
: "N/A";
  ...
  const propertyDetailsList = [
    ...
    { icon: <TbMapPinCode />, label: "Pin Code", value: formData.pinCode },
...
<h4 style={{ color: "rgb(10, 10, 10)", fontWeight: "bold", marginBottom: "10px" }}>123 Property Management</h4>             
...
{showPopup && (
  <div   style={{
           ...
           className="modal show d-block" tabIndex="-1" role="dialog">
    <div   style={{
               position: 'fixed',
               top: '50%',
               left: '50%',
  ...
  <p className="mb-0 flex-grow-1" style={{color:"red", fontSize:"13px"}}>{popupMessage}</p>
  <button
    type="button"
