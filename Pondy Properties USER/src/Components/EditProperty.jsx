...
const isReadOnly = true; // set true to make it readonly
  ...
  return (
    <div className="d-flex align-items-center justify-content-center">
      ...
          </button><h3 className="m-0 ms-3" style={{fontSize:"18px"}}> EDIT PROPERTY </h3> </div>
 ...
 {!isPreview ? (
  ...
  <>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
      <span>{compressionStatus || `Uploading... ${photoProgress}%`}</span>
      <div style={{ width: '200px', height: '5px', backgroundColor: '#e0e0e0', borderRadius: '3px', overflow: 'hidden' }}>
        <div style={{ width: `${photoProgress}%`, height: '100%', backgroundColor: '#2e86e4', transition: 'width 0.3s ease' }}></div>
      </div>
    </div>
  </>
) : photoUploadSuccess ? (
...
{videoloading || isVideoCompressing ? (
  <>
    <Spinner
      animation="border"
      size="sm"
    ...
    />
    <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
      <span>{isVideoCompressing ? `Compressing: ${compressingVideoName}` : `Uploading... ${progress}%`}</span>
      {isVideoCompressing && (
        <div style={{ width: '200px', height: '5px', backgroundColor: '#e0e0e0', borderRadius: '3px', overflow: 'hidden' }}>
          <div style={{ width: `${videoCompressionProgress}%`, height: '100%', backgroundColor: '#2e86e4', transition: 'width 0.3s ease' }}></div>
        </div>
      )}
    </div>
  </>
