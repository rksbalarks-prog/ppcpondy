...
// Visitor follow-ups are keyed only by phone number (no property / buyer id).
// They capture follow-ups for users marked "Visitor" on the Login Report — the
...
visitorFollowUpSchema.pre('save', function (next) {
...
visitorFollowUpSchema.plugin(cityScopePlugin);
